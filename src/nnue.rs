...
impl Network {
    pub fn new() -> Self {
        Self {
            ...
            hidden_layers: [
                Layer::new(&HIDDEN_LAYERS_0_WEIGHT, &HIDDEN_LAYERS_0_BIAS),
                Layer::new(&HIDDEN_LAYERS_1_WEIGHT, &HIDDEN_LAYERS_1_BIAS),
                Layer::new(&HIDDEN_LAYERS_2_WEIGHT, &HIDDEN_LAYERS_2_BIAS),
                Layer::new(&HIDDEN_LAYERS_3_WEIGHT, &HIDDEN_LAYERS_3_BIAS),
                Layer::new(&HIDDEN_LAYERS_4_WEIGHT, &HIDDEN_LAYERS_4_BIAS),
                Layer::new(&HIDDEN_LAYERS_5_WEIGHT, &HIDDEN_LAYERS_5_BIAS),
                Layer::new(&HIDDEN_LAYERS_6_WEIGHT, &HIDDEN_LAYERS_6_BIAS),
                Layer::new(&HIDDEN_LAYERS_7_WEIGHT, &HIDDEN_LAYERS_7_BIAS),
            ],
